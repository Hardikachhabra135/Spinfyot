    ...
    >
      ...
      <div className="sticky top-0 w-full min-h-[100svh] md:min-h-0 md:h-[100svh] flex flex-col justify-center items-center z-20 pt-24 sm:pt-28 md:pt-20 pb-10">
        <div className="w-full max-w-[1250px] mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-center md:justify-between relative">
          ...
          <motion.div
            className="absolute z-30 right-[2%] top-[5%] sm:top-[2%] md:left-[5%] md:top-[15%] md:right-auto"
            style={{
              scaleX: -1,
            }}
          ...
          >
            ...
            <h1 className="font-display text-[clamp(2.5rem,11vw,5.5rem)] lg:text-[7rem] leading-[1.05] drop-shadow-lg flex flex-col gap-1 md:gap-2 mb-0">
            ...
            <motion.div
              variants={ctaVariant}
              className="relative mt-6 md:mt-0 md:absolute left-0 md:-bottom-[140px] w-full flex justify-start"
            >
              <div className="flex flex-col items-start md:items-center mt-0 md:mt-[72px]">
                <SpecularButton
                  ...
                  className="w-[200px] sm:w-[240px] md:w-[320px] shadow-2xl text-[12px] md:text-sm"
                >
          ...
          <motion.div
            className="relative w-[95%] sm:w-[80%] md:w-[45%] mt-6 md:mt-0 h-[45svh] md:h-full flex items-end justify-end md:justify-end z-20 pointer-events-none self-end md:self-auto"
            style={{ y: travelerY }}
          ...
          >
            <div className="relative w-full h-full flex items-end justify-end">
              <motion.img
                ...
                className="w-auto h-full max-h-full object-contain object-bottom drop-shadow-[0_10px_40px_rgba(0,0,0,0.4)]"
                style={{
