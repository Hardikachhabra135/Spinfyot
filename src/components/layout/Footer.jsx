...
const SOCIALS = [
  {
    label: 'WhatsApp',
    href: "https://wa.me/919599558820?text=I'm%20interested",
          ...
          <div className="footer-col contact-col">
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                ...
                <a href="tel:+919599558820" style={{ color: '#D1D5DB', fontSize: '13px', textDecoration: 'none', transition: 'color 0.2s', fontWeight: '300' }} onMouseEnter={e => e.currentTarget.style.color = '#ffffff'} onMouseLeave={e => e.currentTarget.style.color = '#D1D5DB'}>
                  9599558820
                </a>
              </li>
              <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                ...
                <a href="mailto:Info@spinfyot.in" style={{ color: '#D1D5DB', fontSize: '13px', textDecoration: 'none', transition: 'color 0.2s', fontWeight: '300' }} onMouseEnter={e => e.currentTarget.style.color = '#ffffff'} onMouseLeave={e => e.currentTarget.style.color = '#D1D5DB'}>
                  Info@spinfyot.in
                </a>
              </li>
              <li style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                ...
                <span style={{ color: '#D1D5DB', fontSize: '13px', lineHeight: '1.6', fontWeight: '300' }}>
                  Malhan Falcon Plaza, F 10-A,<br/>Plot No-4, Pocket 7, Sector 12 Dwarka,<br/>New Delhi, Delhi 110075
                </span>
              </li>
            </ul>
          </div>
